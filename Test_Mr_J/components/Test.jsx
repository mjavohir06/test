...
const Test = () => {
  ...
  function tr(){
    ...
    const uri=`https://api.mymemory.translated.net/get?q=${data.results[i]?.question}&langpair=en|uz`
    ...
    .then(d=>{
      ...
      if(d.matches!=""){
        ...
        const arr2=d.matches[0].translation.split('&#39;'|| " &#039;")
        for (let i = 0; i < arr2.length; i++) {
          if(i==0){
            ...
            settr(prevState=>prevState+"'"+arr2[i])
